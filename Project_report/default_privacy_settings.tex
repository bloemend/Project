...
There is n o doubt that Facebook has had a remarkable development, both when it comes to number of active users and the development of new features, as shown in the \fref{fig:growth_of_facebook} below. 
...
\subsection{What does Zuckerburg mean}
...
\subsection{Default settings today}
